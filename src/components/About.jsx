      ...
      <div className='flex flex-col justify-center items-center w-full h-full'>
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
          <div className='sm:text-right pb-8 pl-4'>
            <p className='text-4xl font-bold inline border-b-4 border-rose-600 head' data-aos="fade-down">
              About
            </p>
          </div>
          <div></div>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            <div className='sm:text-right text-xl font-bold'>
              <p data-aos="fade-right" > Hello, I'm Farhana! It's a pleasure to meet you. Take a moment to explore my portfolio.</p>
            </div>
            <div>
              <p data-aos="fade-left"> I'm a passionate MERN stack developer with a fresh perspective and a keen eye for turning ideas into reality. 
