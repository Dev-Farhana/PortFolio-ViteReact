  ...
  return (
    ...
    {/* container */}
      <div className='max-w-[1000px] h-full flex flex-col justify-center mx-auto px-12 pt-24 '>
        ...
        <h1 className='font-bold text-4xl sm:text-7xl text-gray-300 title'> Farhana.  </h1>
        <h2 className='font-bold text-4xl sm:text-7xl text-gray-600 '> A Mern Stack Developer. </h2>
        <p className='text-gray-500 max-w-[500px] py-4' > I'm a MERN-Stack developer specializing in building exceptional digital experiences. Currently, I'm focused on
